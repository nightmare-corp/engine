...
//the data needed to make a render_pass and a function that makes a wgpu::RenderPass
pub struct RenderPassRecipe {
...
impl RenderPassRecipe {
    ...
    /// example shader_source: wgpu::ShaderSource::Wgsl(Cow::Borrowed(include_str!("shader/egui.wgsl"))
    pub fn new(
        device: &wgpu::Device,
        ...
        let shader = wgpu::ShaderModuleDescriptor {
            ...
            //TODO this is messy and not reusable
